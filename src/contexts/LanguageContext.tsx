...
const translations = {
  en: {
    ...
    'logistics.title': 'AI Logistics Operations Center',
    'logistics.subtitle': 'Intelligent operations center - Replacing logistics staff',
    'logistics.autoMode': 'Auto Mode',
    'logistics.refresh': 'Refresh',
    'logistics.consolidation': 'Trip Consolidation',
    'logistics.costCalculation': 'Cost Calculation',
    'logistics.monitoring': 'Monitoring',
    'logistics.incidents': 'Incident Management',
    ...
    'logistics.smartConsolidation': 'Smart consolidation based on distance, cargo type and load capacity',

    // Import Export Center
    'importExport.title': 'Import-Export Documentation Center',
    'importExport.subtitle': 'AI-powered customs document generation for VNACCS/E-CUS integration',
    'importExport.documentGeneration': 'Document Generation',
    'importExport.vnaccsIntegration': 'VNACCS Integration',
    'importExport.customsClearance': 'Customs Clearance',
    'importExport.complianceCheck': 'Compliance Check',
