...
const LeafletMapComponent: React.FC<LeafletMapComponentProps> = ({
  ...
  return (
    <div className="relative w-full h-full">
      <div 
        ref={mapRef} 
        className="w-full h-full min-h-[400px] rounded-lg bg-slate-700"
        style={{ zIndex: 1 }}
      />
      
      {/* Route Legend */}
      <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg z-10">
        <h4 className="font-semibold text-sm mb-2 text-gray-800">Chú thích</h4>
        <div className="space-y-1 text-xs">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-green-500 rounded-full border border-white"></div>
            <span className="text-gray-700">Điểm xuất phát</span>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-700">Điểm trung gian</span>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-700">Tuyến đường</span>
          </div>
        </div>
      </div>
